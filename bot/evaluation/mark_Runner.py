...
class HeadlessBenchmark:
    ...
    def _create_heuristic_state(self, game, bullets):
        ...
        try:
            ...
            while True:
                ...
                if getattr(bot, "is_heuristic", False):
                    ...
                    # Tạo state phù hợp cho heuristic
                    heuristic_state = self._create_heuristic_state(game, bullets)
                    action = bot.get_action(heuristic_state)
                else:
